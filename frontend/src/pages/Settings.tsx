  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex-1 space-y-4 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-slate-950/50 p-4 rounded-lg border border-slate-800/50">
                ...
                <div className="mt-1 text-slate-200 font-medium flex items-center gap-2">
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between bg-slate-950/50 p-4 rounded-lg border border-slate-800/50">
          <div>
            <p className="text-slate-200 font-medium">Authentication Provider</p>
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-slate-200 font-medium">Interface Theme</p>
          ...
          <div className="bg-slate-950 p-1 rounded-lg border border-slate-800 flex items-center">
            <button
              ...
              className={`p-2 rounded-md transition-all ${theme === 'light' ? 'bg-slate-800 text-yellow-400 shadow-sm' : 'text-slate-500 hover:text-slate-400'}`}
            >
              <Sun className="w-5 h-5" />
            </button>
            <button
              onClick={() => theme === 'light' && toggleTheme()}
              className={`p-2 rounded-md transition-all ${theme === 'dark' ? 'bg-slate-800 text-indigo-400 shadow-sm' : 'text-slate-500 hover:text-slate-400'}`}
            >
      ...
      <div className="pt-8 border-t border-slate-800">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-red-500/10 hover:bg-red-500/20 text-red-500 rounded-lg border border-red-500/20 transition-all ml-auto"
        >

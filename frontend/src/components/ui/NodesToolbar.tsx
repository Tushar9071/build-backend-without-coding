...
import { Server, Code2, GitFork, Plus, Database, Braces, Send, FileJson, Repeat, Calculator, BarChart, ChevronDown, ChevronUp } from 'lucide-react';
...
export function NodesToolbar({ onAddNode }: NodesToolbarProps) {
    ...
    const nodeTypes = [
        ...
        { type: 'function', label: 'Function', icon: Code2, color: 'text-pink-600 dark:text-pink-400', bg: 'bg-pink-100 dark:bg-pink-500/10', border: 'hover:border-pink-500/50' },
                ...
                {nodeTypes.map((item) => (
                    <button
                        ...
                        onClick={() => {
                            ...
                            // Optional: Close on mobile after selection for better UX

...
import { BarChart, GripHorizontal } from 'lucide-react';
import { useState, useEffect } from 'react';

export function DataNode({ data }: { id: string, data: any }) {
    ...
    return (
        <div className="bg-slate-900 border-2 border-slate-700 hover:border-teal-500 rounded-xl min-w-[280px] shadow-xl transition-all group">
